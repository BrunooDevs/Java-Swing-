...
public class GestionCeldas extends DefaultTableCellRenderer {
    ...
    private ImageIcon iconoGuardar = new ImageIcon(getClass().getResource("/images/1.jpg"));
    private ImageIcon iconoBuscar = new ImageIcon(getClass().getResource("/images/2.jpg"));
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean focused, int row, int column) {
        ...
        Color colorFondoPorDefecto = new Color(85,195,220);
        Color colorFondoSeleccion = new Color(85,195,220);
